...
export const projects = [
  {
    ...
    description: 'Full stack Airbnb clone created with: Next.js (version 13), Tailwind css, Typescript, Prisma, MongoDb, Zustand',
    stack: 'Next.js-13, TS, Tailwind, Prisma, MongoDB, Zustand',  
